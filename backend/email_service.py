    ...
    def _send_via_resend(self, to_email: str, subject: str, html_content: str) -> bool:
        ...
        try:
            ...
            if hasattr(response, 'id'):
                logger.info(f"✓ Resend email ID: {response.id}")
                return True
            ...
            <div style="max-width: 700px; margin: 0 auto; padding: 20px; border: 2px solid #d4af37; border-radius: 10px;">
                ...
                <div style="padding: 30px 20px; background: #f9f9f9; margin: 20px 0; border-radius: 8px;">
                    ...
                    <div style="background: white; padding: 15px; border-radius: 5px; margin: 10px 0;">
                        ...
                        <p style="margin: 5px 0;">{order_data['shipping_address']['city']}, {order_data['shipping_address'].get('postal_code', order_data['shipping_address'].get('zip', ''))}</p>
