...
async def _seo_product_html_impl(ident: str):
    ...
    if not product:
        # Hard 404 HTML so Google does not treat the SPA shell as a soft 404.
        base = _public_base_url()
        html = f"""<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8"/>
<title>Product not found | Kayee01</title>
<meta name="robots" content="noindex, follow"/>
<link rel="canonical" href="{_html_escape(base)}/shop"/>
</head>
<body>
<main>
  <h1>Product not found</h1>
  <p>This product is no longer available.</p>
  <p><a href="{_html_escape(base)}/shop">Continue shopping</a></p>
</main>
</body>
</html>"""
        return Response(
            ...
            headers={"Cache-Control": "public, max-age=120", "X-Robots-Tag": "noindex, follow"},
        )

    base = _public_base_url()
    slug = product.get("slug") or product.get("id") or ident
    # Prefer slug URL as the only indexable product URL.
    if slug and ident != slug:
        return RedirectResponse(url=f"{base}/product/{slug}", status_code=301)
...
<head>
<meta charset="utf-8"/>
<title>Article not found | Kayee01</title>
<meta name="robots" content="noindex, follow"/>
<link rel="canonical" href="{_html_escape(base)}/blog"/>
</head>
<body>
<main>
  <h1>Article not found</h1>
  <p>This article is no longer available.</p>
  <p><a href="{_html_escape(base)}/blog">Back to blog</a></p>
</main>
</body>
</html>"""
        return Response(
